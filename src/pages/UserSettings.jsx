      ...
      <div className="bg-[#1f1f1f] p-8 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-800 text-center">
        ...
        {!isEditing ? (
            <div className='flex flex-col items-center animate-in fade-in duration-300'>
                {/* avatar görünümü */}
                <div className='w-28 h-28 rounded-full bg-gradient-to-tr from-[#ff5252] to-orange-500 flex items-center justify-center text-5xl font-bold text-white shadow-lg mb-6 border-4 border-[#1f1f1f]'>
